...
export default function NeuenWhiskyAnlegen() {
  ...
  async function handleImageUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    for (const file of Array.from(files)) {
      ...
      fd.append('file', file)
      fd.append('slug', form.name.toLowerCase().replace(/\s+/g, '-') || 'whisky')
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="font-playfair text-2xl font-bold text-[#f5f0e8] mb-6">Neuer Whisky</h1>
      {error && (
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Bilder */}
        <section className="bg-[#1a1a1a] border border-amber-900/30 rounded-lg p-6 space-y-4">
          <h2 className="text-amber-400 font-semibold mb-2">Bilder</h2>
          <input
            type="file"
        ...
        <div className="flex gap-3">
          ...
          >
            {saving ? 'Speichern...' : 'Whisky anlegen'}
          </button>
          <button
            type="button"
